...
-- * Modifications should be made in the corresponding script file.
  ...
  -- File:       /home/paul/SSS/Secure-and-Safe-Systems/Problemset 3/MiniProject 5/mark_graph_test.adb
  -- Script:     /home/paul/SSS/Secure-and-Safe-Systems/Problemset 3/MiniProject 5/mark_graph_test.ts


with Ada.Command_Line, Ada.Exceptions;
use type Ada.Command_Line.Exit_Status;

with mark_graph; 	use mark_graph;
with Text_IO;    	use Text_IO;

procedure mark_graph_test is
...
begin  -- unit main block
  ...
  -- Test Case (1)   MARK_GRAPH first test
  declare
  ...
  begin  -- test case
    begin  -- prepare part
      PMarked_Graphs.Graphs.Add_Vertex(G,V); 
    exception
    ...
    begin  -- test part
      v_a1 := PMarked_Graphs.Graphs.All_Vertices(G); 
    ...
    begin  -- result part
      if Driver_Internals.Path_Was ("=>") then
        ...
        then
          ...
          Put_Line ("(1)  MARK_GRAPH first test");
          Put_Line ("           Script name:'mark_graph_test.ts'; Line:4 ");
          Put_Line ("      ...FAIL.");
  ...
  --  End of test cases
  New_Line;
  Put ("Script name 'mark_graph_test.ts'");
